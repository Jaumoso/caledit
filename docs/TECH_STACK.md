...
### Peticiones HTTP: **TanStack Query (React Query) 5.x + Axios**
- React Query para cache, invalidación y sincronización de datos del servidor.
- Axios para configuración centralizada de peticiones (headers de auth, interceptores).
...
- Servidas directamente por Nginx como archivos estáticos (sin pasar por Node.js).
